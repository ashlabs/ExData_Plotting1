...
globalReactivePower <- as.numeric(filteredDataSet$Global_reactive_power)
voltage <- as.numeric(filteredDataSet$Voltage)
subMetering1 <- as.numeric(filteredDataSet$Sub_metering_1)
subMetering2 <- as.numeric(filteredDataSet$Sub_metering_2)
subMetering3 <- as.numeric(filteredDataSet$Sub_metering_3)


png("./images/plot_4.png", width=480, height=480)
par(mfrow = c(2, 2))
